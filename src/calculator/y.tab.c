...
#line 19 "calc.y" /* yacc.c:355  */
    ...
    char sIndex;      /* índice na tabela de símbolos */
...
int main(void) {
    nodeType *root = (nodeType *) yyparse();
    ex(root);
    return 0;
}
